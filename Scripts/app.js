        ...
        $("#loginButton").on("click", function () {
            ...
            $.get("./Data/users.json", function (data) {
                ...
                if (success) {
                    ...
                    console.log("3214")
                    LoadLink("contact-list");
                    $(`<li class="nav-item" id="task"> <a class="nav-link" data="task-list" href="task-list.html"><i class="fas fa-person-circle-check"> </i> Task List </a>`).insertAfter("ul>li#contact");
                }
                else {
